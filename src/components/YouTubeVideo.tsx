...
const YouTubeVideo = () => {
  return <section className="py-20 bg-gray-950">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          <div className="w-full md:w-1/2 lg:w-2/5">
            <p className="text-lg text-gray-300 mb-6 px-0 my-[10px] mx-[10px]">
            ...
            <p className="text-lg text-gray-300 mx-[10px] my-0">
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 max-w-xs mx-auto">
            <div className="relative pb-[177.77%] h-0 bg-black rounded-lg overflow-hidden shadow-xl border-2 border-gold">
              <iframe src="https://www.youtube.com/embed/YFjWt53ccUM" title="Mella Box in Action" className="absolute top-0 left-0 w-full h-full" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </div>
          </div>
        </div>
      </div>
